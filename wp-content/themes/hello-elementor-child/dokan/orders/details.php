...
<div class="dokan-clearfix dokan-order-details-wrap">
    <div class="dokan-w8 dokan-order-left-content">
        ...
        <div class="dokan-clearfix">
            <div class="custom-dokan-details" style="width:100%">
            ...
            <div class="clear"></div>
			 ...
			 <?php do_action('dokan_order_detail_after_downloadable', $order); ?>
        </div>
    </div>

    <div class="dokan-w4 dokan-order-right-content">
        <div class="dokan-clearfix">
            <div class="custom-dokan-general-details" style="width:100%">
                <div class="dokan-panel dokan-panel-default">
            ...
            <div class="custom-dokan-order-notes" style="width:100%">
                <div class="dokan-panel dokan-panel-default">
                        ...
                        <div class="add_note">
                            <?php if ( current_user_can( 'dokan_manage_order_note' ) ) : ?>
                                ...
                                <form class="dokan-form-inline" id="add-order-note" role="form" method="post">
                                    <p>
                                        <textarea type="text" placeholder="Enter note" id="add-note-content" name="note" class="form-control" cols="19" rows="3"></textarea>
                                    </p>
                                    <div class="clearfix">
