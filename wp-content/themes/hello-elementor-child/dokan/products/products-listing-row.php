...
<tr class="<?php echo esc_attr( $tr_class ); ?>">
    ...
    <td data-title="<?php esc_attr_e( 'Earning', 'dokan-lite' ); ?>">
        <?php
            // Calculate profit from sub-orders
            if (function_exists('printlana_calculate_product_profit_from_suborders')) {
                $profit = printlana_calculate_product_profit_from_suborders($product);
            } else {
                // Fallback to default
