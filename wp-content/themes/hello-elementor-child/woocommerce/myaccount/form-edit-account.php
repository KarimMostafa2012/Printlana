...
<form class="woocommerce-EditAccountForm edit-account" enctype="multipart/form-data" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >

	<h2><?php esc_html_e( 'Personal Info', 'woocommerce' ); ?></h2>
