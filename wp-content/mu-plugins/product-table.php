...
class Custom_Product_Table {
    ...
    private function render_styles() {
        ...
        .acf-qty-controls button:hover {
            background: #f0f0f0;
            border-color: #bbb;
        }
        .acf-qty-controls button:active {
            background: #e5e5e5;
        }
        .acf-qty-controls button:disabled {
            opacity: 0.5;
            cursor: not-allowed;
        }
        .acf-qty-controls span {
            min-width: 40px;
            text-align: center;
            font-weight: 600;
            font-size: 16px;
