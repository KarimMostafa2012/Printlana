...
<tr class="<?php echo esc_attr( $tr_class ); ?>">
    ...
    <td data-title="<?php esc_attr_e( 'Earning', 'dokan-lite' ); ?>">
        <?php
            // Calculate profit from sub-orders using our custom function
            if (class_exists('Printlana_Product_Profit_Display')) {
                $profit = Printlana_Product_Profit_Display::calculate_product_profit_from_suborders($product);
            } else {
                // Fallback to default calculation
                $profit = dokan()->commission->get_earning_by_product( $product );
            }
