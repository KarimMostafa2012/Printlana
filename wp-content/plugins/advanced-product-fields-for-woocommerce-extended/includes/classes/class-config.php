    ...
    class Config {
            ...
            $options =  [
                ...
                'vcard'                     => [
                    [
                        'type'              => 'options',
                        'id'                => 'options',
                        'label'             => __('Cards','sw-wapf'),
                        'description'       => __('Define your cards (and their content) here.','sw-wapf'),
                        'inputs'            => [
                            [
                                'title'     => __( 'Description', 'sw-wapf' ),
                                'type'      => 'textarea',
                                'key'       => 'desc'
                            ],
                        ],
                        'button_text'       => __( 'Add card', 'sw-wapf' ),
                        'show_attachment_setting' => true,
                        'show_pricing_options'  => true,
                    ], [
                        'type'                  => 'numbers',
                        'label'                 => __('Selection limits','sw-wapf'),
                        ...
                        'type'                  => 'selects',
                        'label'                 => __('Items per row','sw-wapf'),
                        'description'           => __('Max. cards per row.','sw-wapf'),
                        'tab'                   => 'appearance',
                        'lists'                 => [
                            [
                                'id'            => 'items_per_row',
        ...
        public static function get_function_definitions() {
            ...
            $merge = [
                ...
                'card'  => [
                    'title'         => __('Horizontal cards','sw-wapf'),
                    'description'   => __('A selectable card with informaiton.', 'sw-wapf'),
                    'group_label'   => __('Cards', 'sw-wapf'),
                    'icon'          => '<svg width="16" fill="#828282" height="16" fill-rule="evenodd" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><path d="M28 5H4c-.796 0-1.559.316-2.121.879A2.996 2.996 0 0 0 1 8v16c0 .796.316 1.559.879 2.121A2.996 2.996 0 0 0 4 27h24c.796 0 1.559-.316 2.121-.879A2.996 2.996 0 0 0 31 24V8c0-.796-.316-1.559-.879-2.121A2.996 2.996 0 0 0 28 5Zm0 2H4a.997.997 0 0 0-1 1v16a.997.997 0 0 0 1 1h24a.997.997 0 0 0 1-1V8a.997.997 0 0 0-1-1Z"/><path d="M14.132 13.748a2 2 0 0 0-2-2h-5a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h5a2 2 0 0 0 2-2v-5Zm-2 0v5h-5v-5h5ZM18 13h8a1 1 0 0 0 0-2h-8a1 1 0 0 0 0 2ZM18 17h8a1 1 0 0 0 0-2h-8a1 1 0 0 0 0 2ZM18 21h8a1 1 0 0 0 0-2h-8a1 1 0 0 0 0 2Z"/></svg>'
                ],
                'vcard'  => [
                    'title'         => __('Vertical cards','sw-wapf'),
                    'description'   => __('A selectable card with informaiton.', 'sw-wapf'),
                    'group_label'   => __('Cards', 'sw-wapf'),
                    'icon'          => '<svg width="16" height="16" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" viewBox="0 0 32 32" fill="#828282"><path stroke="null" d="M27 28V4c0-.796-.316-1.559-.879-2.121A2.996 2.996 0 0 0 24 1H8c-.796 0-1.559.316-2.121.879A2.996 2.996 0 0 0 5 4v24c0 .796.316 1.559.879 2.121A2.996 2.996 0 0 0 8 31h16c.796 0 1.559-.316 2.121-.879A2.996 2.996 0 0 0 27 28zm-2 0V4a.997.997 0 0 0-1-1H8a.997.997 0 0 0-1 1v24a.997.997 0 0 0 1 1h16a.997.997 0 0 0 1-1z"/><path d="M8.497 19.715zm3.868-.748h8a1 1 0 0 0 0-2h-8a1 1 0 0 0 0 2zm0 4h8a1 1 0 0 0 0-2h-8a1 1 0 0 0 0 2zm0 4h8a1 1 0 0 0 0-2h-8a1 1 0 0 0 0 2zM20.762 7.008a2 2 0 0 0-2-2h-5a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h5a2 2 0 0 0 2-2v-5zm-2 0v5h-5v-5h5z"/></svg>'
                ],
