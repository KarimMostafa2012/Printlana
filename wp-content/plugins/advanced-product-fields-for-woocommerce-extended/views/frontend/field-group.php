...
// Fixed: Use stack to properly handle nested sections with buttons
...
>
    ...
    foreach( $field_group->fields as $field ) {
        ...
        if($field->type === 'section') {
            ...
            echo '<div data-field-id="' . $field->id . '" class="'.Html::section_container_classes($field).'" style="width: '.$width.'%;" '.(!empty($field->conditionals) ? 'data-wapf-d="'.Util::to_html_attribute_string($field->conditionals).'"' : '').' '.Html::field_container_attributes($field).'>';
