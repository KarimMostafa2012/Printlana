...
namespace SW_WAPF_PRO {
	...
	use SW_WAPF_PRO\Includes\Controllers\Extended_Controller;
    use SW_WAPF_PRO\Includes\Controllers\Linked_Products_Controller;
    ...
    class WAPF
    {
        ...
        public function initialize($version,$base_file) {
	        ...
	        $this->controllers['extended'] = new Extended_Controller();
	        $this->controllers['linked_products'] = new Linked_Products_Controller();
