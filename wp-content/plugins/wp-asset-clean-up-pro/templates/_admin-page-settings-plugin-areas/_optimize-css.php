    ...
    <table class="wpacu-form-table">
        ...
        <tr valign="top">
            ...
            <td>
                ...
                &nbsp;<small>* the individual files will be combined into larger CSS files and referenced from <code style="font-size: inherit;"><?php echo '/'.str_replace(dirname(WP_CONTENT_DIR), '', WP_CONTENT_DIR) . \WpAssetCleanUp\OptimiseAssets\OptimizeCommon::getRelPathPluginCacheDir(); ?>css/</code></small>
                &nbsp;
			    <?php
