...
function homeland_enqueue_carousel_assets()
{
    ...
    // Custom CSS and JS
    wp_enqueue_style('homeland-carousel-style', plugin_dir_url(__FILE__) . 'homeland.css', array(), '1.0.11');
    wp_register_script('homeland-carousel-script', plugin_dir_url(__FILE__) . 'homeland.js', array('gsap-cdn'), '1.0.12', true);
}
