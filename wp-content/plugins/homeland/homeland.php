 ...
 * Description:       A custom carousel for the Homeland theme.
 * Version:           1.0.0
...
function homeland_enqueue_carousel_assets() {
    ...
    // Custom CSS and JS
    wp_enqueue_style( 'homeland-carousel-style', plugin_dir_url( __FILE__ ) . 'carousel.css' );
    wp_register_script( 'homeland-carousel-script', plugin_dir_url( __FILE__ ) . 'carousel.js', array( 'gsap-cdn' ), '1.0.0', true );
}
...
function homeland_carousel_shortcode() {
    ...
    <div class="homeland-carousel-wrapper">
        ...
        <div class="slider-container">
            <button class="nav-arrow nav-arrow-left" onclick="slide(-1)">
                <svg viewBox="0 0 24 24"><path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"/></svg>
            </button>
            <div class="product-showcase" id="productShowcase">
                <!-- Cards will be generated by JavaScript -->
            </div>
            <button class="nav-arrow nav-arrow-right" onclick="slide(1)">
